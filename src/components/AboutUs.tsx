        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            >
              ...
              <div className="absolute -bottom-8 -left-8 bg-vanguard-orange text-white p-8 border-2 border-black shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] z-20">
          ...
          <div className="lg:col-span-7 space-y-12">
            <div className="space-y-6">
              ...
              <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tighter leading-[0.85]">
                NÂNG TẦM <br />
                <span className="text-vanguard-orange">TRẢI NGHIỆM</span> THỂ THAO
              </h2>
            </div>

            <div className="space-y-8 max-w-2xl">
              <p className="text-xl md:text-2xl text-black font-black italic leading-tight border-l-8 border-vanguard-orange pl-8">
                FOX SPORTS THIẾT LẬP MỘT TIÊU CHUẨN MỚI CHO CỘNG ĐỒNG YÊU CẦU LÔNG TẠI VIỆT NAM.
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
              {features.map((f, i) => (
                <div key={i} className="space-y-4 group/item">
                  ...
                  <h4 className="text-sm font-black uppercase tracking-widest text-black group-hover/item:text-vanguard-orange transition-colors">{f.title}</h4>
            ...
            <div className="pt-8">
              <Link 
                to="/contact" 
                className="inline-flex items-center gap-6 bg-black text-white px-12 py-6 font-black uppercase text-xs tracking-[0.2em] hover:bg-vanguard-orange transition-all duration-300 shadow-[10px_10px_0px_0px_rgba(0,0,0,0.1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 group"
              >
                Ghé thăm cửa hàng
